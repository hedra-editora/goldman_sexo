\title{Sobre anarquismo, sexo e casamento}

\author{Emma Goldman}

Mariana Lins (\textit{organização e tradução})

hedra

\chapter*{}

\textbf{edição brasileira©}\quad Hedra 2021\\
\textbf{tradução©}\quad            Mariana Lins\\
\textbf{organização©}\quad         Mariana Lins\\
...
\textbf{\textsc{isbn}}\quad          978-65-89705-23-9
...
\section{A suma sacerdotisa do anarquismo}
...
nosso mundo. Conforme declara em um dos textos aqui traduzidos,\footnote{Conferir ``Anarquia e a questão do sexo''.}
...
controle de natalidade''.} é tudo menos retórica:
...
muito valor a elas.\footnote{Para uma cronologia completa da sua vida, ver: Candance Falk (ed.). \textit{Emma Goldman: A Guide to
...
individuais.\footnote{Ver ``O sufrágio feminino''.}
\end{quote}
...
mais prontamente irá se deixar absorver em seu marido.\footnote{Ver ``Casamento e amor''.}
\end{quote}
...
ricos têm tanto na religião quanto na moralidade''.
...
alguém lhes deve algo no valor de meia dúzia de alfinetes''.\footnote{Ver ``A tragédia da mulher emancipada''.}
...
esperar que a mulher venha a sacrificar tudo por ela''.
Ora, o que não é
...
do casamento''.\footnote{Ver ``Tráfico de mulheres''.}
...
``o sistema industrial não possibilita à maioria das mulheres outra alternativa que não seja a da prostituição''.\footnote{Ver ``Tráfico de mulheres''.}
...
coordenado por cafetões e cadetes se intensificou''.\footnote{Ver ``A hipocrisia do puritanismo''.}
...
tratadas e curadas'\,''. Certamente, teremos muito a ganhar, no caso de refletirmos seriamente sobre esse postulado de aparência tão simples,
...
``devemos mais do que à poesia'':\footnote{Ver ``O elemento sexual da vida''.} do canto dos pássaros à música, da
...
sexuais e amorosas''.\footnote{Ver ``Causas e cura possível para o ciúme''.}
...
sobre o seu ofício.''\footnote{Ver ``Casamento e amor''.}
...
objeto para uma gratificação meramente sexual''.\footnote{Ver ``Tráfico de mulheres''.}
...
chamado do amor e da paixão, independentemente dos costumes e tradição.\footnote{Ver ``Vítimas da moralidade''.}
\end{quote}
...
mulher falha em os unir harmoniosamente''\footnote{Ver ``O elemento sexual da vida''.} --- uma observação
...
sua vida como um todo.\footnote{Ver ``Casamento''.}
\end{quote}
...
ciumentos com pessoas que, na realidade, não lhes importam muito''.\footnote{Ver ``Causas e cura possível para o ciúme''.} Que
...
Nesse sentido, veja a sua definição de \textit{amor}
...
liberdade econômica.\footnote{Ver ``A nova mulher''.}
\end{quote}
...
louvam a maternidade. Não houve crime maior contra a mulher do que esse.\footnote{Ver ``Os aspectos sociais do controle de natalidade''.}
\end{quote}
...
irmã emancipada com a qual nos deparamos comumente''. Tal declaração é inexoravelmente polêmica, posto que
...
significa que eu queira retornar ao passado, como tampouco estou condenando a mulher de volta à sua antiga órbita, como a cozinha e o berçário.\footnote{Ver ``A tragédia da mulher emancipada''.}
\end{quote}
...
%também eram adoradoras de fetiches,
...
chamado `problemas femininos'\,''.\footnote{Ver ``Os aspectos sociais do controle de natalidade''.} Na
...
civilização capitalista será prejudicada.\footnote{Ver ``Os aspectos sociais do controle de natalidade''.}
\end{quote}
...
a se tornar mãe?\footnote{Ver ``Vítimas da moralidade''.}
\end{quote}
...
sua superioridade econômica mesma''.\footnote{Ver ``O sufrágio feminino''.}
...
colocada sobre a terra.\footnote{Ver ``O sufrágio feminino''.}
\end{quote}
...
vitalidade na tentativa de superá-lo''.\footnote{Ver ``O sufrágio feminino''.}
...
transformar em um todo perfeito''.\footnote{Ver ``A tragédia da mulher emancipada''.}
...
amor e o êxtase sem limites''.\footnote{Ver ``A tragédia da mulher emancipada''.}
...
real caráter humano.\footnote{Ver ``Casamento e amor''.}
\end{quote}
...
uma mulher e precisava da companhia de mulheres.
\end{quote}

Sob a luz dessa \textit{leitura econômica de espiritualidade}
...
\chapter{Sobre anarquismo, sexo e casamento}
...
\chapter{O que há na anarquia para as mulheres?\footnote{Entrevista concedida por Emma Goldman
...
\chapter{A hipocrisia do puritanismo\footnote{Sétimo capítulo da coletânea
  \textit{Anarquismo e outros ensaios}, em inglês \textit{Anarchism and Other Essays}, publicada por Goldman na revista \textit{Mother Earth} em 1910.}}
...
\chapter{Causas e possível cura para o ciúme\footnote{Texto não publicado em vida, a data de 1912 é aproximada.}}
...
\chapter{Os aspectos sociais do controle de natalidade\footnote{Texto
...
\chapter{Novamente o movimento do controle de natalidade\footnote{Texto publicado
...
\chapter{A luta do feminismo não foi em vão: a conclusão de Emma Goldman\footnote{Texto originalmente publicado no jornal nova-iorquino \textit{Rochester Times-Union}, em 1926.}}
