...
%[Anarquismo e a questão do sexo \textbf{{[}1896{]}}]
...
Imagine, por um momento, dois cenários do nosso sistema social do século \versal{XIX}.
...
%[O que há no anarquismo para as mulheres? \textbf{{[}1897{]}}]

\epigraph{\textbf{O que a anarquia oferece a mim --- uma mulher?}\\
...
Tom Jones, ela é isto e nada mais. Isso é o penso da mulher.'' %o que penso, o peso? Penso enquanto substantivo?
...
%[A hipocrisia do puritanismo \textbf{{[}1910{]}}]
...
escarlate}.\footnote{Nathaniel Hawthorne,~\emph{A letra escarlate}
  ...
  rígida comunidade puritana de Boston em meados do século \versal{XVII}, narra a história de Hester Prynne, que por ter cometido adultério é obrigada a usar um ``A'' de adúltera,  em cor escarlate, bordado na sua roupa.}
...
%[Tráfico de mulheres \textbf{{[}1910{]}}]
...
casamento.\footnote{É significativo que o livro do Dr.\,Sanger tenha sido
  ...
  verdadeira causa da prostituição. [\versal{N.\,A.}]}

O Dr.\,Alfred Blaschko, na obra \emph{Prostitution in the Nineteenth Century}
{[}A prostituição no século \versal{XIX}{]}, é ainda mais
...
exemplo típico é registrado por Heródoto, no século \versal{V} antes de Cristo,
...
%[O sufrágio feminino \textbf{{[}1910{]}}]
...
mais esclarecida espera um milagre dessa deidade do século \versal{XX} --- o
...
relacionado à política ou não''.\footnote{Helen Sumner. \emph{Equal
  Suffrage.} [\versal{N.\,A.}]} Sim, e uma vez na alma humana, adentram os seus
...
apoio eleitoral em distritos indesejáveis''.\footnote{Dra.\,Helen A.
  Sumner. [\versal{N.\,A.}]} Quão pouco significa a igualdade para elas em
...
de lei de Shackleton,\footnote{{[}Edward Arthur Alexander{]} Schackleton
  ...
  O parlamento inglês está cheio desse tipo de Judas. [\versal{N.\,A.}]} poderão
...
tipógrafos grevistas em Nova York.\footnote{Helen Sumner. \emph{Equal
  Suffrage.} [\versal{N.\,A.}]} Não sei se a atitude dela mudou antes da sua morte.
...
\chapter{A tragédia da mulher emancipada\footnote[*]{Décimo capítulo da coletânea
  ...
  \hedramarkboth{mulher emancipada}{}
%[A tragédia da emancipação feminina \textbf{{[}1910{]}}]
...
semelhante é suficiente. Admitir isso representantes,
...
%[Mary Wollstonecraft: vida trágica e luta apaixonada pela liberdade \textbf{{[}1911{]}}]
...
Muito se tem escrito e dito sobre esta formidável campeã do século \versal{XVIII}, mas o
...
e muito mundana para não ver a discrepância que causou o rompimento do fio da sua alma delicada, complicada --- a discrepância entre o mundo dos seus ideias e o seu universo amoroso.
...
%[Causas e cura possível para o ciúme \textbf{{[}1912{]}}]
...
%[Vítimas da moralidade \textbf{{[}1913{]}}]
...
%[Os aspectos sociais do controle de natalidade \textbf{{[}1916{]}}]
...
\chapter[Novamente o movimento do controle de natalidade]{Novamente o movimento\break do controle de natalidade\footnote[*]{Texto publicado
...
%[Novamente o movimento do controle de natalidade \textbf{{[}1916{]}}]
...
salário de operário num atelier de casacos para crianças do lado leste da
...
fiança de \versal{US}\$ 1000 por ter distribuído folhetos de Controle de
...
isso, foi"-me arbitrada essa fiança de \versal{US}\$ 1000.\footnote{Em janeiro de
...
%[O camaleônico sufrágio feminino \textbf{{[}1917{]}}]
...
rasgou suas roupas, puxou seus cabelos e as alimentou à força\footnote{A
  ...
  sufragistas da \versal{WSPU} --- especialmente, quando presas por atos de vandalismo
...
para o campo militar, para as trincheiras e a morte.\footnote{Dado que,
  ...
  \versal{WSPU} --- que, então recente mãe solteira, passou a dar declarações
...
%[Louise Michel, uma refutação \textbf{{[}1923{]}}]
...
de lamento tenha saído da sua boca. Apesar disso, Sipiridonova é uma pessoinha delicada e
...
%[Mulheres heroicas da Revolução Russa \textbf{{[}1925{]}}]
...
governo de Nicolau \versal{II}, era o polo principal de ``distribuição'' dos
...
de Nicolau \versal{II} superaram até os métodos de Ivan, o Terrível. Depois de
...
%[As visões de Emma sobre o amor \textbf{{[}1926{]}}]
...
hoje.\footnote{Em 1887, antes da sua militância como anarquista, Goldman
  ...
  Numa jogada para lhe retirar o direito de permanecer ou retornar aos \versal{EUA}
...
%[A luta do feminismo não foi em vão \textbf{{[}1926{]}}]
...
%[O elemento sexual da vida \textbf{{[}1935{]}}]
...
únicos que têm em vista. Há, na primeira infância, uma crise
...
perseguição aos homossexuais e às casas de strip"-tease.
