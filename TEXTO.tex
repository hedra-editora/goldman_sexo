...
<<<<<<< HEAD
padroeiro, os quadros sem visão nem liderança de organizações antigas %sem visão e sem liderança, ou os líderes sem visão? trocar ordem para remover ambiguidade
como \emph{Young Men's and Women's Christian Temperance Unions, Purity %esse 's' em Mens seria o genitivo? Men's?
...
<<<<<<< HEAD
higiênico assim como um significado espiritual, o que está muito além da sua influência em apaziguar a curiosidade natural dos jovens ou prevenir %Repensar frase.
